...
const Authenticate = ({ navigation, route } : {navigation : any, route : any}) => {
    ...
    return (
        <YStack space={"$6"}  h={"100%"} paddingVertical={"$4"} paddingHorizontal={"$2"}>
            ...
            <View space="$3">
                ...
                </Button> : <Text textAlign="center" fontSize={14} color={"black"}>Renvoyer le code dans {timer} secondes</Text>}
